...
{
    public class Day25a_congrats : Problem
    {
        ...
        //Собери список всех возможных путей от корня
        //Напиши функцию, которая определяет можно ли пойти по направлению(Это новый путь или обратно)
        //Фонкция которая проведет тебя по пути, посмотрит аутпут, вернет на старт
        //Список полностью исследованных путей
        //Список путей которые надо исследовать
